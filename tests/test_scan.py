...
def test_query_by_single_trial_id(field_trial: field_table.FieldTable):
    ...
    expected = [{'field_trial_id': 'trial_2B', 'phone': '234-567-890', 'person': 'John', 'data_type': 'contact_0'},
        {'field_trial_id': 'trial_2B', 'phone': '234-567-891', 'person': 'Jane', 'data_type': 'contact_1'},
        {'field_trial_id': 'trial_2B', 'amount': Decimal('14.1'), 'solid_or_powder': 'solid', 'type': 'NPK_1', 'fertilizer': 'N', 'data_type': 'management_0'},
        {'field_trial_id': 'trial_2B', 'amount': Decimal('14.7'), 'solid_or_powder': 'powder', 'type': 'NPK_2', 'fertilizer': 'N', 'data_type': 'management_1'},
        {'field_trial_id': 'trial_2B', 'amount': Decimal('37.1'), 'solid_or_powder': 'solid', 'fertilizer': 'P', 'data_type': 'management_2'},
        {'field_trial_id': 'trial_2B', 'amount': Decimal('33'), 'solid_or_powder': 'solid', 'fertilizer': 'P', 'data_type': 'management_3'},
        {'soil_ph': Decimal('5.2'), 'field_trial_id': 'trial_2B', 'soil_type': 'sandy', 'location': 'Loc_0', 'irrigation': 'No', 'data_type': 'meta_0'},
        {'field_trial_id': 'trial_2B', 'treatment': 'T1', 'seed': 'seed_type_A', 'data_type': 'trt_0', 'treatment_name': 'trt_1X'},
        {'field_trial_id': 'trial_2B', 'treatment': 'T2', 'seed': 'seed_type_A', 'data_type': 'trt_1', 'treatment_name': 'trt_2X'},
        {'field_trial_id': 'trial_2B', 'treatment': 'T3', 'seed': 'seed_type_A', 'data_type': 'trt_2', 'treatment_name': 'trt_3X'},
        {'field_trial_id': 'trial_2B', 'treatment': 'T4', 'seed': 'seed_type_A', 'data_type': 'trt_3', 'treatment_name': 'trt_4X'},
        {'field_trial_id': 'trial_2B', 'treatment': 'T5', 'seed': 'seed_type_A', 'data_type': 'trt_4', 'treatment_name': 'trt_5X'},
        {'field_trial_id': 'trial_2B', 'treatment': 'T6', 'seed': 'seed_type_A', 'data_type': 'trt_5', 'treatment_name': 'trt_6X'}]
    result_subset = [x for x in result if not x['data_type'].startswith("plot")]
    result_subset = sorted(result_subset, key=lambda x : x['data_type'])
...
def test_query_by_single_trial_id_sort_key_exact(field_trial: field_table.FieldTable):
    ...
    expected = [{'soil_ph': Decimal('5.2'), 'field_trial_id': 'trial_2B', 'soil_type': 'sandy', 'location': 'Loc_0', 'irrigation': 'No', 'data_type': 'meta_0'}]
    ...
    expected = [{'field_trial_id': 'trial_2B', 'amount': Decimal('14.7'), 'solid_or_powder': 'powder', 'type': 'NPK_2', 'fertilizer': 'N', 'data_type': 'management_1'}]
    assert result == expected
...
def test_query_by_single_trial_id_multi_sort_key_exact(field_trial: field_table.FieldTable):
    ...
    expected = [{'soil_ph': Decimal('5.2'), 'field_trial_id': 'trial_2B', 'soil_type': 'sandy', 'location': 'Loc_0', 'irrigation': 'No', 'data_type': 'meta_0'},
                {'field_trial_id': 'trial_2B', 'phone': '234-567-890','person': 'John', 'data_type': 'contact_0'},
                ]
    assert result == expected
...
def test_get_all_non_standard_info(field_trial: field_table.FieldTable):
    ...
    expected = {'contact_0': [{'field_trial_id': 'trial_2B', 'phone': '234-567-890', 'person': 'John', 'data_type': 'contact_0'}],
        'contact_1': [{'field_trial_id': 'trial_2B', 'phone': '234-567-891', 'person': 'Jane', 'data_type': 'contact_1'}],
        'management_0': [{'field_trial_id': 'trial_2B', 'amount': Decimal('14.1'), 'solid_or_powder': 'solid', 'type': 'NPK_1', 'fertilizer': 'N', 'data_type': 'management_0'}],
        'management_1': [{'field_trial_id': 'trial_2B', 'amount': Decimal('14.7'), 'solid_or_powder': 'powder', 'type': 'NPK_2', 'fertilizer': 'N', 'data_type': 'management_1'}],
        'management_2': [{'field_trial_id': 'trial_2B', 'amount': Decimal('37.1'), 'solid_or_powder': 'solid', 'fertilizer': 'P', 'data_type': 'management_2'}],
        'management_3': [{'field_trial_id': 'trial_2B', 'amount': Decimal('33'), 'solid_or_powder': 'solid', 'fertilizer': 'P', 'data_type': 'management_3'}],
        'meta_0': [{'soil_ph': Decimal('5.2'), 'field_trial_id': 'trial_2B', 'soil_type': 'sandy', 'location': 'Loc_0', 'irrigation': 'No', 'data_type': 'meta_0'}]
        }
    assert result == expected
...
def test_get_by_sort_key_exact(field_trial: field_table.FieldTable):
    ...
    data = {'field_trial_id': {0: 'trial_4D', 1: 'trial_3C', 2: 'trial_2B'},
            'data_type': {0: 'contact_0', 1: 'contact_0', 2: 'contact_0'},
...
def test_get_by_sort_key(field_trial: field_table.FieldTable):
    ...
    data = {'field_trial_id': {0: 'trial_4D', 1: 'trial_3C', 2: 'trial_2B'},
            'data_type': {0: 'meta_0', 1: 'meta_0', 2: 'meta_0'},
    ...
    data = {'field_trial_id': {0: 'trial_4D', 1: 'trial_4D', 2: 'trial_4D', 3: 'trial_4D', 4: 'trial_3C', 5: 'trial_3C', 6: 'trial_3C', 7: 'trial_3C', 8: 'trial_2B', 9: 'trial_2B', 10: 'trial_2B', 11: 'trial_2B'},
            'data_type': {0: 'management_0', 1: 'management_1', 2: 'management_2', 3: 'management_3', 4: 'management_0', 5: 'management_1', 6: 'management_2', 7: 'management_3', 8: 'management_0', 9: 'management_1', 10: 'management_2', 11: 'management_3'},
