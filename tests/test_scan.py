...
def test_list_all_sort_keys(field_trial):
    ...
    expected = ['contact', 'management_0', 'management_1', 'management_2', 'management_3', 'meta',
...
def test_get_by_sort_key(field_trial):
    ...
    data = {'soil_ph': {0: 7.4, 1: 6.3, 2: 5.2},
            ...
            'irrigation': {0: 'Yes', 1: 'Yes', 2: 'No'}, 'info': {0: 'meta', 1: 'meta', 2: 'meta'}
            }
    ...
    data = {'trial_id': {0: 'trial_4D', 1: 'trial_3C', 2: 'trial_2B'},
            ...
            'info': {0: 'contact', 1: 'contact', 2: 'contact'}}
    expected = pd.DataFrame(data)
    assert_frame_equal(result, expected)
