...
def test_query_df_all_plots_treatments(field_trial: field_table.FieldTable):
    ...
    df_merged = pd.merge(df_plot, df_trt, how="inner", on=['field_trial_id', "treatment"])

    df_plot_trt = field_trial.query_df_plot_treatment(trial_id)
    data = {
        'field_trial_id': {0: 'trial_2B', 1: 'trial_2B', 2: 'trial_2B', 3: 'trial_2B', 4: 'trial_2B', 5: 'trial_2B', 6: 'trial_2B', 7: 'trial_2B', 8: 'trial_2B', 9: 'trial_2B', 10: 'trial_2B', 11: 'trial_2B', 12: 'trial_2B', 13: 'trial_2B', 14: 'trial_2B', 15: 'trial_2B', 16: 'trial_2B', 17: 'trial_2B', 18: 'trial_2B', 19: 'trial_2B', 20: 'trial_2B', 21: 'trial_2B', 22: 'trial_2B', 23: 'trial_2B'},
        'record_type_x': {0: 'plot_1-1', 1: 'plot_1-5', 2: 'plot_2-3', 3: 'plot_4-2', 4: 'plot_1-2', 5: 'plot_1-6', 6: 'plot_2-5', 7: 'plot_3-3', 8: 'plot_1-3', 9: 'plot_2-1', 10: 'plot_4-3', 11: 'plot_4-5', 12: 'plot_1-4', 13: 'plot_3-1', 14: 'plot_3-2', 15: 'plot_4-4', 16: 'plot_2-2', 17: 'plot_3-4', 18: 'plot_3-6', 19: 'plot_4-1', 20: 'plot_2-4', 21: 'plot_2-6', 22: 'plot_3-5', 23: 'plot_4-6'},
        ...
        'record_type_y': {0: 'trt_2', 1: 'trt_2', 2: 'trt_2', 3: 'trt_2', 4: 'trt_0', 5: 'trt_0', 6: 'trt_0', 7: 'trt_0', 8: 'trt_3', 9: 'trt_3', 10: 'trt_3', 11: 'trt_3', 12: 'trt_5', 13: 'trt_5', 14: 'trt_5', 15: 'trt_5', 16: 'trt_4', 17: 'trt_4', 18: 'trt_4', 19: 'trt_4', 20: 'trt_1', 21: 'trt_1', 22: 'trt_1', 23: 'trt_1'},
...
def test_query_df_all_plots_treatments_2(field_trial: field_table.FieldTable):
    ...
    df_plot = field_trial.query_df_all_plots(trial_id)
    df_trt = field_trial.query_df_all_treatments(trial_id)
    df_merged = pd.merge(df_trt, df_plot, how="inner", on=['field_trial_id', "treatment"])
...
def test_query_df_all_trt(field_trial: field_table.FieldTable):
    ...
    trial_id = "trial_2B"
    df_trt = field_trial.query_df_all_treatments(trial_id)
    data = {'field_trial_id': {0: 'trial_2B', 1: 'trial_2B', 2: 'trial_2B', 3: 'trial_2B', 4: 'trial_2B', 5: 'trial_2B'},
            'record_type': {0: 'trt_0', 1: 'trt_1', 2: 'trt_2', 3: 'trt_3', 4: 'trt_4', 5: 'trt_5'},
...
def test_query_df_all_trt_multi(field_trial: field_table.FieldTable):
    ...
    data = {'field_trial_id': {0: 'trial_2B', 1: 'trial_2B', 2: 'trial_2B', 3: 'trial_2B', 4: 'trial_2B', 5: 'trial_2B', 6: 'trial_3C', 7: 'trial_3C', 8: 'trial_3C', 9: 'trial_3C', 10: 'trial_3C', 11: 'trial_3C'},
            'record_type': {0: 'trt_0', 1: 'trt_1', 2: 'trt_2', 3: 'trt_3', 4: 'trt_4', 5: 'trt_5', 6: 'trt_0', 7: 'trt_1', 8: 'trt_2', 9: 'trt_3', 10: 'trt_4', 11: 'trt_5'},
